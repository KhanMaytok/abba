...
import ctypes
ctypes.windll.kernel32.SetConsoleTitleW("ChaosCrawler v1.19.5")
...
def main():
    wincapture = WindowCapture("LOST ARK (64-bit, DX11) v.2.16.1.1")
    print()
    print("Welcome to Gaming Legion's Chaos Dungeon Bot")
    print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
    print("You are using ChaosCrawler: v1.19.5")
    print("Latest update: 11th Mai 2023")
    print("Homepage: www.gaming-legion.net")
    print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
    print("!!!! BEFORE WE START !!!!")
    print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
    print("Change the resolution to 1080p in Lost Ark & Windows.")
    print("Force 21:9 aspect ratio.")
    print("Change HUD size: 110%.")
    print("Change Minimap transparency: 100%.")
    print("Change Minimap Zoom: 65%.")
    print("Also try to deactivate HDR if your Monitor supports this.")
    print("If you still facing some issues, try our Troubleshooting Thread.")
    print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
    print("!!!! IMPORTANT !!!!")
    print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
    print("Please report all bugs and compatibility issues to our forum support area.")
    print()
    print("Best Regards")
    print("Tempritscher")
    print()
    ...
    while True:
        if states["status"] == "inCity":
            ...
            inChaos = pyautogui.locateCenterOnScreen(
                "./data/inChaos.png", confidence=0.75, region=(247, 146, 222, 50)
            )
...
def enterChaos():
    ...
    if config["shortcutEnterChaos"] == True:
        ...
        while True:
            ...
            aor = pyautogui.locateCenterOnScreen(
                "./data/aor.png", confidence=0.8, region=(592, 304, 192, 95)
            )
        ...
        while True:
            ...
            enterHand = pyautogui.locateOnScreen(
                "./data/enterChaos.png", confidence=config["confidenceForGFN"]
            )
            if enterHand != None:
    ...
    while True:
        ...
        enterServer = pyautogui.locateCenterOnScreen(
            "./data/enterServer.png", confidence=0.98, region=(885, 801, 160, 55)
        )
...
def doFloor3Portal():
    ...
    for i in range(0, 15):
        ...
        bossBar = pyautogui.locateOnScreen(
            "./data/bossBar.png", confidence=0.7, region=(406, 159, 1000, 200)
        )
        if normalMob == True:
            return
...
def checkFloor2Boss():
    ...
    bossLocation = pyautogui.locateCenterOnScreen(
        "./data/boss.png", confidence=0.65, region=config["regions"]["minimap"]
    )
...
def checkFloor3Tower():
    tower = pyautogui.locateCenterOnScreen(
        "./data/tower.png", region=config["regions"]["minimap"], confidence=0.7
    )
...
def checkChaosFinish():
    clearOk = pyautogui.locateCenterOnScreen(
        "./data/clearOk.png", confidence=0.75, region=(625, 779, 500, 155)
    )
    """
    selectLevelButton = pyautogui.locateCenterOnScreen(
    "./data/selectLevel.png",
...
def fightFloor2Boss():
    if pyautogui.locateOnScreen(
        "./data/bossBar.png", confidence=0.8, region=(406, 159, 1000, 200)
    ):
...
# def windowCheck():
#     if pyautogui.locateOnScreen(
#         "./data/close.png", grayscale=True, confidence=0.9
#     ):
...
def clearQuest():
    quest = pyautogui.locateCenterOnScreen(
        "./data/quest.png", confidence=0.9, region=(815, 600, 250, 200)
    )
    leveledup = pyautogui.locateCenterOnScreen(
        "./data/leveledup.png", confidence=0.9, region=(815, 600, 250, 200)
    )
...
def offlineCheck():
    ...
    ok = pyautogui.locateCenterOnScreen(
        "./data/ok.png", region=config["regions"]["center"], confidence=0.75
    )
    enterServer = pyautogui.locateCenterOnScreen(
        "./data/enterServer.png",
        confidence=config["confidenceForGFN"],
...
def restartGame():
    ...
    while True:
        enterGame = pyautogui.locateCenterOnScreen(
            "./data/steamPlay.png", confidence=0.75
        )
        sleep(500, 600)
        stopGame = pyautogui.locateCenterOnScreen(
            "./data/steamStop.png", confidence=0.75
        )
        sleep(500, 600)
        confirm = pyautogui.locateCenterOnScreen(
            "./data/steamConfirm.png", confidence=0.75
        )
        sleep(500, 600)
        enterServer = pyautogui.locateCenterOnScreen(
            "./data/enterServer.png",
...
def buyAuctionFirstFav():
    while True:
        ...
        gold2 = pyautogui.locateCenterOnScreen(
            "./data/gold2.png", region=(934, 415, 36, 20), confidence=0.9
        )
        gold1 = pyautogui.locateCenterOnScreen(
            "./data/gold1.png", region=(934, 415, 36, 20), confidence=0.9
        )
        if gold1 != None:
            # click price input
